...
// const FormElements = ({ motionText, buttonText, additionalText, linkText, urlLogin, urlRegister ,handleSubmit, toaster}) => {
//   const mText = additionalText.split('');
...
//         `}
//       </style>
//       <form className="container" onSubmit={(e) => handleSubmit(e, toaster)}>
//         {motionText.map((label, index) => (
//           <div key={index} className="input-group">
//             <motion.label
//               whileHover={{ scale: 1.1, color: '#2ecc71' }}
