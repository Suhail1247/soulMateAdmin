...
Create a Plan
              ...
              <div className="col-12 d-flex justify-content-center mt-2">
                {/* <table style={{ borderCollapse: 'collapse', width: '100%' }}>
                  <thead>
                    <tr style={{ border: '1px solid #ddd', padding: '8px', textAlign: 'center' }}>
                      <th style={{ border: '1px solid #ddd', padding: '8px' }}>Sl.No</th>
                      <th style={{ border: '1px solid #ddd', padding: '8px' }}>Price ( in $ )</th>
                      <th style={{ border: '1px solid #ddd', padding: '8px' }}>Period</th>
                      <th style={{ border: '1px solid #ddd', padding: '8px' }}>Number of boost</th>
                      <th style={{ border: '1px solid #ddd', padding: '8px' }}>Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    {plan.map((item, index) => (
                      <tr key={index} style={{ border: '1px solid #ddd', padding: '8px', textAlign: 'center' }}>
                        <td style={{ border: '1px solid #ddd', padding: '8px' }}>{index + 1}</td>
                        <td style={{ border: '1px solid #ddd', padding: '8px' }}>{item.Price}</td>
                        <td style={{ border: '1px solid #ddd', padding: '8px' }}>{item.Period}</td>
                        <td style={{ border: '1px solid #ddd', padding: '8px' }}>{item.NoOfBoost}</td>
                        <td>
                          <RiDeleteBin2Fill
